...
set rc [catch {
  ...
  add_files -quiet D:/COlab4/COlab4.runs/synth_1/top.dcp
...
set rc [catch {
  ...
  create_report "impl_1_route_report_timing_summary_0" "report_timing_summary -max_paths 10 -file top_timing_summary_routed.rpt -warn_on_violation  -rpx top_timing_summary_routed.rpx"
